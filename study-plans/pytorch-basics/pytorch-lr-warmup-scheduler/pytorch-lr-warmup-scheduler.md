...
- The rate reaches zero at step total_steps, which lies just beyond the returned schedule. The last returned step still has a positive rate.
...
- Phase 2 (decay): cosine annealing from base_lr toward zero over the remaining returned steps
